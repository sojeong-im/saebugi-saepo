...
export const cellCharacters = [
  { id: 1, name: '친화력세포', story: '먼저 다가가고 친해지는 걸 좋아해요!', mission: '다른 팀원 3명과 하이파이브 영상 찍기!', img: '/친화력세포.png' },
  { id: 2, name: '낯가림세포', story: '낯선 사람 앞엔 숨고 싶지만 마음은 착해요!', mission: '조용히 구석에서 손가락 하트 영상 찍기!', img: '/낯가림세포.png' },
  ...
  { id: 8, name: '출출이세포', story: '출출할 땐 참지 않아요! 맛있는 게 최고!', mission: '구역원들과 간식 먹는 인증샷 찍기!', img: '/출출이세포.png' },
  { id: 9, name: '배려세포', story: '누구보다 먼저 챙기는 따뜻한 마음!', mission: '옆 사람 안마해주는 훈훈한 영상 찍기!', img: '/배려세포.png' },
  { id: 10, name: '승부욕세포', story: '1등만 보여요! 끝까지 포기하지 않아요!', mission: '가위바위보 이길 때까지 도전하는 영상 찍기!', img: '/승부욕세포.png' },
];
